...
<head>
    ...
    <title>{{ config('app.name', 'Eweb1640') }}</title>
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-icon ">
                    <img src="{{ asset('img/brain-thinking.svg') }}" width="40%">
                </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('ideas.index') }}"><i class="far fa-lightbulb mr-2"></i> View Ideas</a>
                        <a class="collapse-item" href="{{ route('ideas.create') }}"><i class="far fa-plus-square mr-2"></i>Add an Idea</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('categories.index') }}"><i class="far fa-list-alt mr-2"></i>View Categories</a>
                        <a class="collapse-item" href="{{ route('categories.create') }}"><i class="fas fa-plus-circle mr-2"></i></i>Create Categories</a>
                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('departments.index') }}">Departmet list</a>
                        <a class="collapse-item" href="{{ route('departments.create') }}">Add a Department</a>
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-light border-left" type="button">
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; www.ideation.com 2023</span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
