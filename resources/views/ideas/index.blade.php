                ...
                <div class="card" style="width: 18rem;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Most Popular Ideas <span
                                class="badge bg-primary ml-2 text-color-sidebar">2</span>
                        </li>
                        <li class="list-group-item">Most Viewed Idea <span
                                class="badge bg-primary ml-2 text-color-sidebar">10</span></li>
                        <li class="list-group-item">Latest Idea <span
                                class="badge bg-primary ml-2 text-color-sidebar">15</span></li>
                    </ul>
                </div>
                                ...
                                <div class="d-flex flex-row justify-content-between align-items-center p-2 border-bottom">
                                    <div class="d-flex flex-row align-items-center feed-text px-2">
                                        ...
                                        <div class="d-flex flex-column flex-wrap ml-2"><span
                                                class="font-weight-bold">{{ $idea->name }}
